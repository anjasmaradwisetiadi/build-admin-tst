        ...
        <div class="relative overflow-x-auto">
            <div class="p-4">
                <div class="bg-blue-600 text-white py-2 px-4 rounded-t-md">
                    <h1 class="text-lg font-semibold">Top Pembeli Table ({{ datas?.period }})</h1>
                </div>
                    ...
                    <div class="flex w-full overflow-x-auto overflow-y-auto">
                        <table class="min-w-full divide-y divide-gray-200 overflow-x-auto overflow-y-auto ">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr v-if="getLoading ">
                                    <td
                                            class="px-6 py-4 whitespace-nowrap text-center h-[10rem]" colspan="3">
                                        <div 
...
import { dataDummyEmployee, topBuyer } from '@/utilize/DataDummy';
const datas = ref(topBuyer)
